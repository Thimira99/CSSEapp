...
export default class OrderSummaryScreen extends React.Component {
   ...
   */
  createOrder() {
    var url = 'http://10.0.2.2:8080/order/createOrder';
    var data = {
            ...
            <View style={styles.cardRow}>
              ...
              <View style={styles.cardColumn}>
                ...
                <Text style={[styles.txt, {textAlign: 'left'}]}>
                  {this.state.orderDetails.material}
                </Text>
                <Text style={[styles.txt, {textAlign: 'left'}]}>
                  {this.state.orderDetails.quantity}
                </Text>
                <Text style={[styles.txt, {textAlign: 'left', width: 200}]}>
                  {this.state.orderDetails.deadline}
                </Text>
              </View>
            </View>
          </ScrollView>
